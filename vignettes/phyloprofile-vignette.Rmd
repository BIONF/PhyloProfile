...
knitr::include_graphics("../www/posterSub.png")
```
...
### See ?phyloprofile::getDendrogram for more details.
...
#' Check ?phyloprofile::getDistanceMatrix
profileType <- "binary"
...
### See ?phyloprofile::estimateGeneAge for more details.
...
### See ?phyloprofile::getCoreGene for more details.
...
```{r}
?phyloprofile::getSignificantGenes
```
...
### See ?phyloprofile::createVarDistPlot for more details.

#' Load built-in data
data("mainLongRaw", package="phyloprofile")

#' Process data for distribution analysis
#' See ?phyloprofile::createVariableDistributionData
...
#' see ?phyloprofile::createLongMatrix
...
#' Then use ?phyloprofile::highlightProfilePlot function
